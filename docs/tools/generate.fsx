...
let website = "/MongoDB.Bson.FSharp"

let githubLink = "https://github.com/vilinski/MongoDB.Bson.FSharp"

// Specify more information about your project
let info =
  [ "project-name", "MongoDB.Bson.FSharp"
    "project-author", "Andreas Vilinski <vilinski@yahoo.de>"
    "project-summary", "MongoDB Bson serializers for F# types"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/MongoDB.Bson.FSharp" ]
